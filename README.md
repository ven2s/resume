...
### **인스에듀테인먼트**
#### Creccer 유지보수 (Creccer, CreccerAcademy, 전쟁기념관, 제주민속촌)<br>
 - 진행기간 : 2018.06.01 ~ <br>
 - 주요내용 : 기존 Creccer 어플 유지보수<br>
...
#### 개항박물관Creccer<br>
 - 진행기간 : 2018.07.12~2018.08.13 (신규런칭 개발기간)<br>
 - 주요내용 : 개항박물관Creccer 신규화면 제작 및 신규 유니티 통합 빌드 <br>
 - 공헌내용 : 기존 Creccer 에서 새로운화면 추가 및 신규유티티 빌드 통합<br>
 - 사용기술 : Objective-C, Cocoapods, AWSS3<br>
 - 최종결과 : 2018.08.13 릴리즈 및 이후 유지보수<br>
